...
{
	public class AdminDal : EfEntityRepositoryBase<Admin, EComDbContext>
	{
		private AdminDal() { }
		public static AdminDal This
		{
			get
			{
				Instance ??= new();
		...
		public bool HasPermission(int adminId, int permissionId)
		{
			...
			return RoleBindDal.This.Any(x => x.PermissionId == permissionId && x.RoleId == admin.RoleId && x.IsValid == true);
		}
